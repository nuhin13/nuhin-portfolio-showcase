      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
        <div className="md:col-span-7 space-y-6 animate-fade-in">
          ...
          <p className="text-gray-600 max-w-2xl">
            Experienced Blockchain Developer with a passion for building decentralized
            applications. I specialize in Web3 development, smart contracts, and
            creating seamless user experiences in the blockchain space.
          </p>
